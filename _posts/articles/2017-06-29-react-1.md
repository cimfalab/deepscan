...
<table class="table">
  ...
  <tbody>
    <tr>
      <td style="" rowspan="2"><a href="https://deepscan.io/docs/rules/react-api-typo/" class="btn">REACT_API_TYPO</a></td>
      <td style="">'componentDidUpate' could be a typo. Did you mean 'componentDidUpdate'?
<div class="highlighter-rouge"><pre class="highlight"><code>componentDidUpate() {
    this.check();
}
</code></pre></div>
      </td>
...
<div class="highlighter-rouge"><pre class="highlight"><code>export class GooglePlusSharePreview extends PureComponent {
    static PropTypes = {
</code></pre></div>
      </td>
    </tr>
...
DeepScan의 [BAD_RENDER_RETURN_VALUE](https://deepscan.io/docs/rules/bad-render-return-value/) 규칙은 `render` 함수의 반환 값을 체크하고 적절한 반환 값에 대한 가이드를 제공해 개발자의 실수를 방지할 수 있습니다.
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td style="" rowspan="2"><a href="https://deepscan.io/docs/rules/bad-render-return-value/" class="btn">BAD_RENDER_RETURN_VALUE</a></td>
...
<div class="highlighter-rouge"><pre class="highlight"><code>if ( ! this.props.site || ! this.props.plugin ) {
    return;
}
</code></pre></div>
      </td>
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td style="" rowspan="2"><a href="https://deepscan.io/docs/rules/missing-return-value/" class="btn">MISSING_RETURN_VALUE</a></td>
      <td style="">No value is returned from function 'recordFieldFocus' defined at line 133.
<div class="highlighter-rouge"><pre class="highlight"><code>onFocus={ this.recordFieldFocus( 'roles' ) }
</code></pre></div>
      </td>
    </tr>
  </tbody>
...
React의 DOM element에서 React의 속성이 아닌 기존 DOM 속성을 사용하는 경우입니다.
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td style="" rowspan="2"><a href="https://deepscan.io/docs/rules/bad-unknown-prop/" class="btn">BAD_UNKNOWN_PROP</a></td>
